...
PACKAGE_ROOT = Path("/root/jeeb-msi-runtime-activation-bootstrap-v8")
...
FILES = (
    ...
    FileSpec(
        ...
        "b5af4d006242589a0c4add05377146021ed172a72c22000a5f25297f163daddf",
        0o755,
        predecessor_sha256=(
    ...
    FileSpec(
        ...
        "f655b65f774b7b3898f43c4a060fc707639a62f98b14993466f5d995e0207a6b",
        0o755,
        predecessor_sha256=(
