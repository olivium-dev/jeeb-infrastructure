...
HEALTH_URL="${JEEB_CMS_HEALTH_URL:-http://127.0.0.1/healthz}"
GATEWAY_READY_URL="${JEEB_CMS_GATEWAY_READY_URL:-http://127.0.0.1/gateway/health/ready}"
RELEASE_URL="${JEEB_CMS_RELEASE_URL:-http://127.0.0.1/release.json}"
MANIFEST_URL="${JEEB_CMS_MANIFEST_URL:-http://127.0.0.1/SHA256SUMS}"
