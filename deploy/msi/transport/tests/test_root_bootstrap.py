...
V2_PACKAGE_PATH = ROOT / "jeeb-msi-runtime-activation-bootstrap-v2.tar"
...
V7_PACKAGE_PATH = ROOT / "jeeb-msi-runtime-activation-bootstrap-v7.tar"
V8_PACKAGE_PATH = ROOT / "jeeb-msi-runtime-activation-bootstrap-v8.tar"
PACKAGE_PATH = ROOT / "jeeb-msi-runtime-activation-bootstrap-v9.tar"
...
class RootBootstrapTests(unittest.TestCase):
    ...
    def test_v9_install_uses_the_shared_root_owned_nonblocking_lock(self):
        parent = type(
    ...
    def test_checked_in_package_and_unprivileged_stage_workflow_are_exact(self):
        ...
        self.assertEqual(
            hashlib.sha256(V2_PACKAGE_PATH.read_bytes()).hexdigest(),
            "1d9aa98e9b2d5bed1f600a8875268d2fa2122f305d93900f93b9e4d4c59da2bf",
        )
        self.assertEqual(
            hashlib.sha256(V3_PACKAGE_PATH.read_bytes()).hexdigest(),
            "f06719d1412ed8d5ac604abde6e402dd969284180c1af447fd75b30d1633d0bc",
        )
        self.assertEqual(
            hashlib.sha256(V4_PACKAGE_PATH.read_bytes()).hexdigest(),
            "e40b37a1c03962e0e496c774c19436ae3120b955a42485442fcba737ba2db22d",
        )
        self.assertEqual(
            hashlib.sha256(V5_PACKAGE_PATH.read_bytes()).hexdigest(),
        ...
        self.assertEqual(
            hashlib.sha256(V7_PACKAGE_PATH.read_bytes()).hexdigest(),
            "ced9d9a5f559e8e91864479cfc432715f577096f8a2b765de180f0d26d1a003d",
        )
        self.assertEqual(
            hashlib.sha256(V8_PACKAGE_PATH.read_bytes()).hexdigest(),
            "cd23aef3e60eaa23793f108b776352420bbe9858e8460b2334bffdd24d56e1da",
        )
        self.assertEqual(
            hashlib.sha256(PACKAGE_PATH.read_bytes()).hexdigest(),
            "eb7ab758caa553908bdb87aea05f70c7f11057e2cac697e324a767fff8cc9059",
        )
        ...
        self.assertIn("jeeb-msi-runtime-activation-bootstrap-v9.tar", workflow)
        self.assertIn("eb7ab758caa553908bdb87aea05f70c7f11057e2cac697e324a767fff8cc9059", workflow)
        ...
        self.assertIn(
            ...
            "jeeb-msi-runtime-activation-bootstrap-v9-eb7ab758.tar",
            runbook,
        )
        self.assertIn(
            "eb7ab758caa553908bdb87aea05f70c7f11057e2cac697e324a767fff8cc9059",
        ...
        self.assertIn(
            "f95eeb90b731dc9957ff0a772ed16161d9ff37b7fd754bb1457c3f3ec99ff0f3",
            runbook,
        )
        self.assertIn(
